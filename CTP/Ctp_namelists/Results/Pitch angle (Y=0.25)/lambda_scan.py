...
ax1.set_xticks([0.1*i for i in range(6)])
ax1.set_yticks([0.6 + 0.1*i for i in range(5)])
ax1.set_ylim([0.6,1])
# ax1.set_xlim([0,1.05])
...
ax2.set_xticks([0.1*i for i in range(6)])
ax2.set_yticks([0.1*i for i in range(5)])
